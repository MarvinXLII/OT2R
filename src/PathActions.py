...
class PathActions:
    ...
    def __init__(self):
        ...
        self.hearDB = Data.getInstance('NPCHearData')
        self.leadDB = Data.getInstance('NPCLeadData')
        self.battleDB = Data.getInstance('NPCBattleData')
